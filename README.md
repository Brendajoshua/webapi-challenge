...
Middleware is an  array of functions that connects network-based requests generated by a client to the back-end data the client is requesting,they get executed in the order they are introduced into the server code.
